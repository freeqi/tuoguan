<template>
  <div id="medical">
    <medical-record-list-temp :api="api" @on-change="changePatient">
      <div slot="content" style="height:96%;">
        <ul class="tab-panel">
          <li
              ...
              <div class="pdf-view">
                ...
                >
                  <p>
                    ...
                    <a :href="`${baseUrl}Document/fileview/${medicalRecordChecked.id}`"></a>
                  </p>
                </object>
        ...
        <div class="table2" v-else>
          ...
          <div>
            ...
            <div class="table2-content">
              <Table :columns="table_columns" :data="table_date" :loading="loading"></Table>
            </div>
          </div>
          <div class="table_detail" v-show="table_detail_flag">
            <div class="head_content">
              ...
              <p class="record">
                ...
                <span
                  v-if="formDetail.chargeStatus === '2'"
                  class="default"
                >未收费</span>
              ...
              <p class="items-box">
                ...
                <span>{{formDetail.chargeTime}}</span>
                ...
                <span class="red">￥{{formDetail.totalPrice || '-'}}</span>
              </p>
            </div>
            <Divider></Divider>
            <Table
...
export default {
  ...
  methods: {
    ...
    showDetail (row) {
      ...
      // this.table_detail_columns =
      //   this.tabCheckedInfo.id === 3
      //     ? this.table_charge_detail_columns
      //     : this.table_prescription_detail_columns
      // //
      // this.table_detail_data =
      //   this.tabCheckedInfo.id === 3 ? this.table_detail_demo_date : []
    ...
    changeTab (id) {
      ...
      this.swsApi.swsPost(url, params).then(res => {
        if (res.data.success) {
