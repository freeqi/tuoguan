      ...
      <div class="tab-content" slot="content">
        <div class="table">
          <div style="margin: 10px;">
            ...
            >
              <Option
                v-for="item in hospitalList.filter(
                  item => item.dialysisId !== '0'
                )"
                :key="item.dialysisId"
                :value="item.dialysisId"
                >{{ item.dialysisName }}</Option
            ...
            <span
              style="padding: 0 19px;font-size: 18px;"
              v-show="tabCheckedId == 1"
            >
              <RadioGroup
                v-model="typeCheckedId"
          ...
          <div class="table_title">
            <p class="p" v-if="!hasPage">
              ...
              <span v-show="tabCheckedId === 1"
                >（{{ this.type[this.typeCheckedId - 1].title }}）</span
              >
            </p>
            <p class="p" v-else>
              {{ hospitalCheckedId === "0" ? "透析中心" : hospitalCheckedName
              }}{{ title }}
        ...
        <div class="table">
          ...
          <p class="p" v-show="detailTableFlag">
            {{ detailTableCheckedInfo.name }}{{ title }}({{
              detailTableCheckedInfo.prescriptionNo
            }})明细表
          </p>
          <Table
          ...
          <div v-show="isTab3">
            <div class="time">
              ...
              <span>
                时间：
                <label v-show="isTab3"
                  >{{ this.monthFirst }} 至 {{ this.monthLast }}</label
                >
  ...
  data() {
    return {
      ...
      listColumns: [
        ...
        { title: "统筹", key: "detc", align: "center", minWidth: 70 },
        { title: "大额", key: "ybjj", align: "center", minWidth: 70 },
