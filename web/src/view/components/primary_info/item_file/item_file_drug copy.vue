          ...
          <Row>
            ...
            <Col span="12">
              <FormItem label="别名" prop="aliasName">
                <Input
                  placeholder="请输入"
                  v-model="formValidate.aliasName"
                  :disabled="lock"
                  :readonly="readonly"
                ></Input>
              </FormItem>
            ...
            <Col span="12">
              <FormItem label="英文名称" prop="englishName">
                <Input
                  placeholder="请输入"
                  v-model="formValidate.englishName"
                  :disabled="lock"
                  :readonly="readonly"
                ></Input>
              </FormItem>
            ...
            <Col span="12">
              <FormItem prop="forms" label="剂型">
                <Cascader :data="Form" v-model="formValidate.forms" :disabled="lock||readonly"></Cascader>
              </FormItem>
            </Col>
          </Row>
          <Row>
            ...
            <Col span="12">
              <FormItem prop="isSplited" label="是否可拆分">
                <RadioGroup v-model="formValidate.isSplited">
                  <Radio :label="1" :disabled="lock||readonly">是</Radio>
                  <Radio :label="0" :disabled="lock||readonly">否</Radio>
                </RadioGroup>
              </FormItem>
            </Col>
            <Col span="12">
          ...
          <Row>
            ...
            <Col span="12">
              <FormItem prop="doseUnit" label="剂量单位">
                <Select v-model="formValidate.doseUnit" :disabled="lock||readonly">
            ...
            <Col span="12">
              <FormItem prop="feeTypeId" label="费用类别">
                <Select v-model="formValidate.feeTypeId" :disabled="lock||readonly">
                  <Option :value="item.id" v-for="(item, i) in FeeTypeId" :key="i">{{item.name}}</Option>
                </Select>
              </FormItem>
            </Col>
            <!-- <Col span="12">
              <FormItem prop="procurementPackage" label="采购包装">
                <Input placeholder="请输入" v-model="formValidate.procurementPackage" :readonly="readonly" :disabled="lock"></Input>
              </FormItem>
            </Col>
            <Col span="12">
              <FormItem prop="procurementUnit" label="采购单位">
                <Select v-model="formValidate.procurementUnit"  :disabled="lock||readonly">
            ...
            <!-- <Col span="12">
              <FormItem prop="packageSpecifications" label="采购拆分规则">
                <InputNumber placeholder="请输入" :readonly="readonly" :min="0" v-model="formValidate.packageSpecifications" style="width:100%"  :disabled="readonly"></InputNumber>
              </FormItem>
            </Col>-->
          </Row>
          <Row>
            ...
            <Col span="12">
              <FormItem label="首批进货人员" prop="firstStock">
                <Input
                  placeholder="请输入"
                  :readonly="readonly"
                  v-model="formValidate.firstStock"
                  :disabled="lock"
                ></Input>
              </FormItem>
            </Col>
            <!-- <Col span="12">
              <FormItem prop="supplierId" label="供货商">
                <Select v-model="formValidate.supplierId"  :disabled="lock||readonly">
            ...
            <Col span="12">
              <FormItem prop="isSalesReturn" label="是否可退货">
                <RadioGroup v-model="formValidate.isSalesReturn">
                  <Radio :label="0" :disabled="lock||readonly">不可退货</Radio>
                  <Radio :label="1" :disabled="lock||readonly">可退货</Radio>
                </RadioGroup>
              </FormItem>
            </Col>
            <Col span="24">
            ...
            <Col span="12">
              <FormItem label="采购价" prop="medicalDrugExtension.purchasingPrice">
                <InputNumber
                  :min="0"
                  :readonly="readonly"
                  class="w-100"
            ...
            <!-- <Col span="12">
              <FormItem label="零售价" prop="medicalDrugExtension.retailPrice">
                <InputNumber :min="0" :readonly="readonly" class="w-100" placeholder="请输入" v-model="formValidate.medicalDrugExtension.retailPrice" :disabled="editLock"></InputNumber>
              </FormItem>
            </Col>-->
            <Col span="12">
...
export default {
  ...
  methods: {
    ...
    copyValue () {
      ...
      this.copiedFormValidate = JSON.parse(JSON.stringify(this.formValidate))
    },
    // 黏贴字段
    stickValue () {
      ...
      this.formValidate = JSON.parse(JSON.stringify(this.copiedFormValidate))
    },
    // 获取数据字典
    getDicList () {
      let apiList = [
