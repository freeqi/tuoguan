  ...
  methods: {
    ...
    setOption (curRow) {
      ...
      if (curRow.hasOwnProperty('bgsj')) { // 看数据为区分医保中心目录
        ...
        let { hiCenterCode, hiCenterLevel, manufacturer, goodsName, minDose, id, medicalItemName,nationItemCode} = curRow
        // this.compareInfo.medicalItemInput.hiCenterCode = hiCenterCode
        this.compareInfo.medicalItemInput.hiCenterLevel = hiCenterLevel
        ...
        this.compareInfo.medicalItemInput.salePrice = curRow.medicalDrugExtension.purchasingPrice
