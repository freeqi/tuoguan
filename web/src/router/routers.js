      ...
      },
      {
        ...
        children: [
          ...
          },
          {
            ...
            component: () => import('@/view/components/organization/staff_transfer/staff_transfer')
          }
        ]
      },
      {
  ...
  // 运行管理
  {
    ...
    children: [
      ...
      },
      {
        ...
        name: 'dialysis',
        meta: {
          icon: '_iconfont icon-tongji',
          title: '患者透析充分性'
        },
        component: () =>
          import('@/view/components/operation_management/dialysis/dialysis_adequacy.vue')
      },
      {
        path: 'result',
        name: 'result',
        ...
        component: () =>
          import('@/view/components/operation_management/result/test_result.vue')
      },
      {
        path: 'sensing',
        name: 'sensing',
        ...
        component: () =>
          import('@/view/components/operation_management/sensing_data/sensing_data.vue')
      },
      {
        path: 'equipment',
        name: 'equipment',
      ...
      },
      {
        ...
        component: () =>
          import(
            '@/view/components/operation_management/scrap_checkout/scrap_checkout'
          )
      },
      {
        path: 'unsalable_audit',
        name: 'unsalable_audit',
        meta: {
          icon: 'ios-copy-outline',
          title: '预警审核'
        },
        component: () =>
          import(
            '@/view/components/operation_management/unsalable_audit/unsalable_audit'
          )
      },
      {
        path: 'medical',
    ...
    children: [
      {
        ...
        component: () =>
          import('@/view/components/system_management/version_manage/version_manage')
      },
      {
        path: 'user_manage',
        name: 'user_manage',
      ...
      {
        path: 'purchase_requistion_manage',
        name: 'purchase_requistion_manage',
        meta: {
          icon: 'md-key',
          title: '采购审批配置'
        },
        component: () =>
          import(
            '@/view/components/system_management/purchase_requistion_manage'
          )
      },
      {
        path: 'message_center',
  ...
  // 基础档案
  {
    ...
    children: [
      ...
      },
      {
        ...
        children: [
          ...
          },
          {
            ...
            component: () =>
              import(
                '@/view/components/primary_info/medical_comparsion/consumables/consumables'
              )
          },
          {
            path: 'compare_review',
            ...
            component: () =>
              import(
                '@/view/components/primary_info/medical_comparsion/compare_review/compare_review'
              )
          },
          {
            path: 'directory_update_list',
            name: 'directory_update_list',
            meta: {
              title: '目录更新列表'
            },
            component: () =>
              import(
                '@/view/components/primary_info/medical_comparsion/directory_update_list/directory_update_list'
              )
          },
          {
            path: 'monthly_check',
            ...
            component: () =>
              import(
                '@/view/components/primary_info/medical_comparsion/monthly_check/monthly_check'
              )
          },
        ]
      },
      ...
      },
      {
        ...
        component: () =>
          import('@/view/components/primary_info/itemlink')
      },
      {
        path: 'supplier',
        name: 'supplier',
