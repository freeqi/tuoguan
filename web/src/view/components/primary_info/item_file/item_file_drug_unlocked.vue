            ...
            <Row>
              ...
              <Col span="12">
                <FormItem prop="packageUnit" label="包装单位">
                  <Select v-model="formValidate.packageUnit" filterable :disabled="lock||readonly">
                    <Option
                      :value="item.id"
              ...
              <Col span="12">
                <FormItem prop="approvalNum" label="批准文号">
                  <Input
                    placeholder="请输入"
                    :readonly="readonly"
                    v-model="formValidate.approvalNum"
                  ></Input>
                </FormItem>
              </Col>
              <Col span="12">
                <FormItem prop="medicalThan" label="件比">
                  <Input
                    placeholder="请输入"
                    v-model="formValidate.medicalThan"
                    :readonly="readonly"
                  ></Input>
                </FormItem>
              </Col>
              ...
              <Col span="12">
                <FormItem prop="specificationsQuantity" label="包装拆分规则">
                  <InputNumber
                    ...
                    style="width:100%"
                    :disabled="formValidate.isSplited!==1"
                    :readonly="readonly"
                  ></InputNumber>
                </FormItem>
              </Col>
              ...
              <Col span="12">
                <FormItem label="自然年最大使用量" prop="yearDosage">
                  <InputNumber
                    ...
                    :readonly="readonly"
                    placeholder="请输入"
                    v-model="formValidate.yearDosage"
                    :disabled="editLock"
                  ></InputNumber>
                </FormItem>
              </Col>
...
export default {
        ...
        },
        {
          ...
          render: (h, params) => {
            if (params.row.applyState === 1) {
              return <i-button type="success" size="small" onClick={() => this.applyStateToggle(params.row)}>可采购</i-button>
            } else {
              return <i-button type="error" size="small" onClick={() => this.applyStateToggle(params.row)}>禁止采购</i-button>
            }
          }
        },
        {
  ...
  methods: {
    applyStateToggle (row) {
      ...
      this.swsApi.swsGet(`Data/MedicalItemRecord/ApplyState/${row.id}/${state}`)
        .then(res => {
